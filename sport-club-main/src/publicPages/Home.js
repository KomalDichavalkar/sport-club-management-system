      ...
      >
        <div className="carousel-inner">
          ...
          <div className="carousel-item active">
            <img src="/slider/swimmingpool.jpg" className="d-block w-100" alt="Swimming Pool" />
          ...
          <div className="carousel-item">
            <img src="/slider/gym.jpg" className="d-block w-100" alt="Gym" />
            <div className="hero-overlay">
          ...
          <div className="carousel-item">
            <img src="/slider/badmintoncourt.jpeg" className="d-block w-100" alt="Badminton Court" />
            <div className="hero-overlay">
